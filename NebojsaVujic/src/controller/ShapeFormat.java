...
public class ShapeFormat {
	...
	public static String describeShape(Shape s) {
	    ...
	    if (s instanceof Line l) {
	        return String.format("Line start=(%d,%d) end=(%d,%d) color=%s",
	 ...
	 private static Color color(String hex) { return Color.decode(hex); }
	    ...
	    /*public static Shape findByDescription(DrawingModel model, String desc) {
	        for (Shape s : model.getShapes()) {
	            if (ShapeFormat.describeShape(s).equals(desc)) return s;
	        }
	        return null;
	    }*/
}
